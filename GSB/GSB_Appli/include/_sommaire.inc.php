...
?>
    ...
    <?php
	  ...
	  if ($libelleType == "administrateur") {
    ?>
           <li class="smenu">
               <a href="vTypes.php" title="Maintenance des types d'utilisateurs">Type utilisateurs</a>
           </li>
           <li class="smenu">
               <a href="vUtilisateurs.php" title="Maintenance des utilisateurs">Utilisateurs</a>
           </li>
    <?php
    }
    ?>
